...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		...
		vector<VertexFormat> vertices2
		{
			VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(1, -1,  1), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(-3, 1,  1), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(1, 1,  1), glm::vec3(1, 0, 1)),
			VertexFormat(glm::vec3(-1, -1,  -1), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(1, -1,  -1), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(-1, 1,  -1), glm::vec3(0, 1, 1)),
		...
		Mesh *Patrat = CreateMesh("Patrat", verticesP, indicesP);
		...
		// Create a new mesh from buffer data
		Mesh *tetraedru = CreateMesh("tetraedru", vertices2, indices);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	// render an object using colors from vertex
	RenderMesh(meshes["Patrat"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(0.33f));




	// render an object using colors from vertex
	RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(-1.5f, 2.5f, 0), glm::vec3(0.33f));
